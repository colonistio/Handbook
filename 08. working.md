...
### Task Checklist 
+ Does it fit our pillars?
+ [Does it fit our values?](https://colonist.io/values)
+ Does it address our biggest bottleneck?
...
+ If all code functions start with lowercase, don’t write new functions that start with uppercase.
+ If all web page designs have a blue background, don’t add a new page with a green background.
